...
## Note:  I have added a html file and one json file, running that on browser and adding that json file in choosen file option, you will get a Interactive Sales Dashboard of Walmart. 
